...
class MQA(nn.Module):
    def __init__(self, embed_dim, n_heads):
        ...
        # !!!修改点：embed_dim -> self.head_size
        self.k_proj = nn.Linear(embed_dim, self.head_size, bias=False)
        self.v_proj = nn.Linear(embed_dim, self.head_size, bias=False)
